...
# VAP Coniferous Finland 2001-2018 (Datatype)

`ogc.bioclima.ebv.vap-coniferous` *v0.2.0*

Concrete EBV dataset: yearly maps of the start of the Vegetation Active Period in coniferous forests of Finland, 2001-2018, derived from MODIS Fractional Snow Cover. Packaged as a CoverageJSON document conformant to the bioclima-coverage profile. This is one of the two input EBVs consumed by the Phenological Change Indicator (PCI).
...
GeoBON-style metadata describing the coniferous VAP EBV dataset.
...
- type: object
  properties:
    ebv_entity:
      ...
      properties:
        ebv_entity_type:
          const: https://maytetoscano.github.io/bblocks-bioclima/ontology/entity/coniferous-forest
...
* [▶ Open this layer in the BioClima interactive map viewer](https://maytetoscano.github.io/bblocks-bioclima/viewer/?layer=vap-coniferous)
...
* Path: `_sources/ebv/vap-coniferous`
